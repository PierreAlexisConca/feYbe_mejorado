...
public class SupplierRest {
    ...
    public List<ProveedorTransaccionalResponse> findAllTransaccional() {
        return supplierService.findAllTransaccional();
    }

    @PostMapping("/transaccional")
    public ProveedorTransaccionalResponse saveTransaccional(@Valid @RequestBody ProveedorTransaccionalRequest request) {
        return supplierService.saveTransaccional(request);
    }
