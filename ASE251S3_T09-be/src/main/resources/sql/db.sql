...
-- [MAESTRO] Tabla usuarios
-- Solo los usuarios registrados aquí pueden iniciar sesión.
-- password: exactamente 5 dígitos numéricos.
-- estado: 'A' = activo, 'I' = inactivo. Solo usuarios activos pueden entrar.
CREATE TABLE usuarios (
    id         BIGINT       IDENTITY(1,1) PRIMARY KEY,
    email      VARCHAR(100) NOT NULL UNIQUE,
    password   CHAR(5)      NOT NULL
                            CONSTRAINT ck_usuarios_password CHECK (password NOT LIKE '%[^0-9]%' AND LEN(password) = 5),
...
-- [TRANSACCIONAL] Tabla movimiento_producto
-- Registra cada entrada/salida de stock de un producto.
...
-- ----------------------------------------
-- Usuarios del sistema (solo estos pueden iniciar sesión)
-- password: 5 dígitos numéricos únicos por usuario.
-- Para agregar un nuevo usuario desde la BD, basta insertar
-- una fila aquí con estado = 'A' y ya puede iniciar sesión.
-- ----------------------------------------
INSERT INTO usuarios (email, password, nombre, estado)
VALUES
('pierre@agricolafloreza.com',  '12345', 'Pierre',  'A'),
('anthony@agricolafloreza.com', '23456', 'Anthony', 'A'),
('massiel@agricolafloreza.com', '34567', 'Massiel', 'A');
GO
